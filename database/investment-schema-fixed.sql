-- Investment Module Schema (Fixed RLS Policies)
...
-- Investment Rounds RLS (Fixed to use organization_members)
...
-- Investors RLS (Fixed to use organization_members)
...
-- Round Investors RLS (Fixed to use organization_members)
...
-- Cap Table RLS (Fixed to use organization_members)
...
-- Investment Milestones RLS (Fixed to use organization_members)
...
-- Investment Documents RLS (Fixed to use organization_members)
...
-- Investment Notes RLS (Fixed to use organization_members)
