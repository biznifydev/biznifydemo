-- Seed test budget data for organization: 682405ba-4c6f-4415-b103-89fd64ff8ce4
-- This script creates a sample budget with categories, subcategories, and budget items

-- First, let's get the section IDs
DO $$
DECLARE
    ...
    saas_sales_subcategory_id UUID;
    consulting_category_id UUID;
    consulting_subcategory_id UUID;
    hosting_category_id UUID;
    hosting_subcategory_id UUID;
    marketing_category_id UUID;
    marketing_subcategory_id UUID;
...
BEGIN
    ...
    -- Get the first user ID (or you can specify a specific user ID)
    ...
    -- Get the consulting category ID (be more specific)
    ...
    RETURNING id INTO saas_sales_subcategory_id;

    -- Get the consulting subcategory ID (be more specific)
    SELECT id INTO consulting_subcategory_id 
    FROM budget_subcategories 
    WHERE budget_id = test_budget_id AND name = 'Project Consulting' AND category_id = consulting_category_id
    LIMIT 1;
    ...
    RETURNING id INTO hosting_subcategory_id;
    ...
    -- Get the admin category ID (be more specific)
    ...
    RETURNING id INTO marketing_subcategory_id;

    -- Get the admin subcategory ID (be more specific)
    SELECT id INTO admin_subcategory_id 
    FROM budget_subcategories 
    WHERE budget_id = test_budget_id AND name = 'Office Supplies' AND category_id = admin_category_id
    LIMIT 1;
    ...
    INSERT INTO budget_items (
        ...
        -- Revenue items
        (test_budget_id, '682405ba-4c6f-4415-b103-89fd64ff8ce4', revenue_section_id, sales_category_id, saas_sales_subcategory_id, 
         120000, 10000, 10000, 10000, 10000, 10000, 10000, 10000, 10000, 10000, 10000, 10000, 10000,
         'Monthly SAAS subscription revenue', user_id),
        
        (test_budget_id, '682405ba-4c6f-4415-b103-89fd64ff8ce4', revenue_section_id, consulting_category_id, consulting_subcategory_id, 
         60000, 5000, 5000, 5000, 5000, 5000, 5000, 5000, 5000, 5000, 5000, 5000, 5000,
         'Consulting project revenue', user_id),
        
        -- COGS items
        (test_budget_id, '682405ba-4c6f-4415-b103-89fd64ff8ce4', cogs_section_id, hosting_category_id, hosting_subcategory_id, 
         24000, 2000, 2000, 2000, 2000, 2000, 2000, 2000, 2000, 2000, 2000, 2000, 2000,
         'Monthly cloud hosting costs', user_id),
        
        -- Expenses items
        (test_budget_id, '682405ba-4c6f-4415-b103-89fd64ff8ce4', expenses_section_id, marketing_category_id, marketing_subcategory_id, 
         36000, 3000, 3000, 3000, 3000, 3000, 3000, 3000, 3000, 3000, 3000, 3000, 3000,
         'Monthly digital marketing spend', user_id),
        
        (test_budget_id, '682405ba-4c6f-4415-b103-89fd64ff8ce4', expenses_section_id, admin_category_id, admin_subcategory_id, 
         12000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000,
         'Monthly office supplies and admin costs', user_id);
