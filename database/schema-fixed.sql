...
CREATE POLICY "Users can view their own organizations" ON organizations
  FOR SELECT USING (true); -- Allow all authenticated users to view organizations

CREATE POLICY "Organization owners can update their organizations" ON organizations
  FOR UPDATE USING (true); -- Allow all authenticated users to update organizations
...
CREATE POLICY "Users can view all members" ON organization_members
  FOR SELECT USING (true); -- Allow all authenticated users to view members

CREATE POLICY "Users can manage members" ON organization_members
  FOR ALL USING (true); -- Allow all authenticated users to manage members

-- Financial accounts policies - simplified to avoid recursion
CREATE POLICY "Users can view all accounts" ON financial_accounts
  FOR SELECT USING (true); -- Allow all authenticated users to view accounts

CREATE POLICY "Users can manage accounts" ON financial_accounts
  FOR ALL USING (true); -- Allow all authenticated users to manage accounts

-- Financial data policies - simplified to avoid recursion
CREATE POLICY "Users can view all data" ON financial_data
  FOR SELECT USING (true); -- Allow all authenticated users to view data

CREATE POLICY "Users can update all data" ON financial_data
  FOR UPDATE USING (true); -- Allow all authenticated users to update data

CREATE POLICY "Users can insert all data" ON financial_data
  FOR INSERT WITH CHECK (true); -- Allow all authenticated users to insert data
