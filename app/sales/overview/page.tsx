...
export default function SalesCRMOverviewPage() {
  ...
  const renderContent = () => {
    switch (activeTab) {
            ...
            <div className="bg-white rounded-lg p-6">
              <div className="text-center space-y-4">
                <div className="space-y-2">
                  <p className="text-gray-600">Hi, I'm your AI Sales assistant</p>
                  <div className="flex items-center justify-center space-x-2">
                    <svg className="h-4 w-4 text-gray-600" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                    </svg>
                    <h2 className="text-xl font-bold text-gray-800">Ask me for sales insights and lead management</h2>
                  </div>
                </div>
                ...
                <div className="relative max-w-2xl mx-auto">
                  <input
                    type="text"
                    placeholder="Ask about leads, deals, customer insights, or sales strategies"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-[#f2f3f7] rounded-lg border border-gray-200 p-6 relative overflow-hidden hover:shadow-md transition-shadow cursor-pointer">
                  <div className="relative z-10">
                    <h4 className="font-semibold text-gray-800 mb-2">Add Lead</h4>
                    <p className="text-sm text-gray-600">Capture and qualify new sales leads.</p>
                  </div>
                ...
                <div className="bg-[#f2f3f7] rounded-lg border border-gray-200 p-6 relative overflow-hidden hover:shadow-md transition-shadow cursor-pointer">
                  <div className="relative z-10">
                    <h4 className="font-semibold text-gray-800 mb-2">Create Deal</h4>
                    <p className="text-sm text-gray-600">Track opportunities through the pipeline.</p>
                  </div>
                  <div className="absolute top-4 right-4 border-2 border-white rounded-lg p-2">
                    <svg className="h-6 w-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="bg-[#f2f3f7] rounded-lg border border-gray-200 p-6 relative overflow-hidden hover:shadow-md transition-shadow cursor-pointer">
                  <div className="relative z-10">
                    <h4 className="font-semibold text-gray-800 mb-2">Customer Management</h4>
                ...
                <div className="bg-[#f2f3f7] rounded-lg border border-gray-200 p-6 relative overflow-hidden hover:shadow-md transition-shadow cursor-pointer">
                  <div className="relative z-10">
                    <h4 className="font-semibold text-gray-800 mb-2">Sales Reports</h4>
                    <p className="text-sm text-gray-600">Analyze performance and trends.</p>
                  </div>
                  <div className="absolute top-4 right-4 border-2 border-white rounded-lg p-2">
                    <svg className="h-6 w-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      case "pipeline":
        return <div className="text-gray-600">Sales pipeline content coming soon...</div>
      case "performance":
        return <div className="text-gray-600">Sales performance content coming soon...</div>
      default:
        return null
    }
  }
  ...
  return (
    <PageWrapper
      ...
      subHeader={<SubHeader tabs={salesTabs} activeTab={activeTab} onTabChange={setActiveTab} />}
    >
      {renderContent()}
    </PageWrapper>
  )
