...
async function setupBudgetSystem() {
  ...
  try {
    ...
    await supabase.rpc('exec_sql', { sql: budgetSchema });
    ...
    `;
    await supabase.rpc('exec_sql', { sql: rlsSetup });
    ...
    `;
    await supabase.rpc('exec_sql', { sql: triggers });
    ...
    `;
    await supabase.rpc('exec_sql', { sql: defaultSections });
